#!/usr/bin/env python3
"""依 references/research/archetypes.yaml 規則回填 references/docs/*.profile.yaml 的 archetype 欄位"""
...
ARCHETYPES_PATH = ROOT / "references" / "research" / "archetypes.yaml"
...
def write_profile(profile: dict, path: Path) -> None:
    header = (
        ...
        "# 產生：python .agents/skills/agi/scripts/generate_profiles.py\n"
        "# archetype：python .agents/skills/agi/scripts/assign_archetypes.py\n\n"
    )
